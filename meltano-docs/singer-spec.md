...
## Singer Spec[#](https://hub.meltano.com/singer/spec/#singer-spec)
...
This documentation is our attempt at simplifying the canonical specification into an easier to understand and follow format for people who are new to the Singer community. The full specification is in the [Singer](https://github.com/singer-io/getting-started/blob/master/docs/SPEC.md) project on GitHub.

## Version[#](https://hub.meltano.com/singer/spec/#version)

The current version of the spec is 0.3.0 and is versioned using [Semantic Versioning](https://semver.org/).

## Basics[#](https://hub.meltano.com/singer/spec/#basics)
...
### Taps[#](https://hub.meltano.com/singer/spec/#taps)
...
| File | Description |
| --- | --- |
| [`config.json`](https://hub.meltano.com/singer/spec/#config-files) | JSON-formatted file containing any information needed for a tap to run. This can include authorization information such as username and password, date parameters to specify when to start extracting, and anything else useful for pulling a specific set of data. |
| [`state.json`](https://hub.meltano.com/singer/spec/#state-files) | JSON-formatted file used to store information between when taps are run. There is no specification for the format of a state file other than the JSON requirement. If a tap is able to accept a state file it is expected that it will output state messages as well. |
| [`catalog.json`](https://hub.meltano.com/singer/spec/#catalog-files) | JSON-formatted file that specifies which streams and entities within the streams, such as columns or fields, to extract. It also can define how streams are replicated and can include extra metadata about a particular stream. |

### Targets[#](https://hub.meltano.com/singer/spec/#targets)
...
### Taps | Targets[#](https://hub.meltano.com/singer/spec/#taps--targets)
...
## Details[#](https://hub.meltano.com/singer/spec/#details)

### Messages[#](https://hub.meltano.com/singer/spec/#messages-1)
...
#### Records[#](https://hub.meltano.com/singer/spec/#records)
...
#### Schemas[#](https://hub.meltano.com/singer/spec/#schemas)
...
##### What is a JSON Schema?[#](https://hub.meltano.com/singer/spec/#what-is-a-json-schema)
...
##### Optional SCHEMA message properties[#](https://hub.meltano.com/singer/spec/#optional-schema-message-properties)
...
#### Ordering of SCHEMA and RECORD Messages[#](https://hub.meltano.com/singer/spec/#ordering-of-schema-and-record-messages)
...
#### State[#](https://hub.meltano.com/singer/spec/#state)
...
### Taps[#](https://hub.meltano.com/singer/spec/#taps-1)
...
#### Config Files[#](https://hub.meltano.com/singer/spec/#config-files)
...
#### State Files[#](https://hub.meltano.com/singer/spec/#state-files)
...
#### Catalog Files[#](https://hub.meltano.com/singer/spec/#catalog-files)
...
-   `schema` - this is the JSON schema of the stream, which will be passed in a [SCHEMA message](https://hub.meltano.com/singer/spec/#schemas) to the Target

Optional properties within the list are:

-   `table_name` - this is only used for a database source and is the name of the table
-   `metadata` - this is a list that defines extra information about items within a stream. This is discussed more in the [Metadata](https://hub.meltano.com/singer/spec/#metadata) section below
...
##### Discovery Mode[#](https://hub.meltano.com/singer/spec/#discovery-mode)
...
##### Metadata[#](https://hub.meltano.com/singer/spec/#metadata)
...
| `replication-method` | All | Either `FULL_TABLE`, `INCREMENTAL`, or `LOG_BASED`. The replication method to use for a stream. See [Data Integration](https://docs.meltano.com/guide/integration#replication-methods) for more details on the replication type. |
...
##### Putting it Together[#](https://hub.meltano.com/singer/spec/#putting-it-together)
...
#### Metrics[#](https://hub.meltano.com/singer/spec/#metrics)
...
##### Timer for Failed HTTP GET[#](https://hub.meltano.com/singer/spec/#timer-for-failed-http-get)
...
##### Counter for Records[#](https://hub.meltano.com/singer/spec/#counter-for-records)
...
##### Log Output[#](https://hub.meltano.com/singer/spec/#log-output)
...
### Targets[#](https://hub.meltano.com/singer/spec/#targets-1)
...
#### Config Files[#](https://hub.meltano.com/singer/spec/#config-files-1)
...
#### State Files[#](https://hub.meltano.com/singer/spec/#state-files-1)
...
#### Schema Files[#](https://hub.meltano.com/singer/spec/#schema-files)
